# Generated by Django 3.2.15 on 2023-05-13 22:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='elements', to='foodcartapp.order', verbose_name='')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='elements', to='foodcartapp.product', verbose_name='')),
            ],
            options={
                'verbose_name': 'Содержание заказа',
                'verbose_name_plural': 'Содержание заказа',
                'unique_together': {('order', 'product', 'quantity')},
            },
        ),
    ]
